...
var DependenTree = function () {
  ...
  function DependenTree() {
    ...
    (0, _classCallCheck3.default)(this, DependenTree);
  ...
  (0, _createClass3.default)(DependenTree, [{
    key: "build",
    ...
    value: function rollUp(applicator) {
      ...
      var promisify = function promisify(node) {
        return new _promise2.default(function (resolve, reject) {
          _promise2.default.all(node.children.map(promisify)).then(function (success) {
